...
<a href="fm_my_listed_bikes.php?pagenum=<?php echo $nextpage; ?>">NEXT</a>
<a href="fm_my_listed_bikes.php?pagenum=<?php echo $lastpage; ?>">LAST</a>
<?php } elseif ($pagenum == $lastpage and $pagenum != 1) { ?>
<a href="fm_my_listed_bikes.php?pagenum=1">FIRST</a>
<a href="fm_my_listed_bikes.php?pagenum=<?php echo $prevpage; ?>">PREV</a>
