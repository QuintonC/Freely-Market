...
$sql = "SELECT count(*) FROM Equipment_Listing AS e, Pending_Equipment AS s WHERE e.eid = s.eid AND s.username = '$username' AND status = 'Active'";
...
<a href="fm_my_placed_equipment_offers.php?pagenum=<?php echo $nextpage; ?>">NEXT</a>
<a href="fm_my_placed_equipment_offers.php?pagenum=<?php echo $lastpage; ?>">LAST</a>
<?php } elseif ($pagenum == $lastpage and $pagenum != 1) { ?>
<a href="fm_my_placed_equipment_offers.php?pagenum=1">FIRST</a>
<a href="fm_my_placed_equipment_offers.php?pagenum=<?php echo $prevpage; ?>">PREV</a>
