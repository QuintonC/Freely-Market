...
$id = $_GET['id'];
#Diaplay the Listing
$mysql = "select * from Equipment_Listing where eid = '$id'";
$result = $conn->query($mysql);
#Diplay accounts of offers made for listing
$sql1 = "select peid, username from Pending_Equipment where eid = '$id'";
...
<table>
	...
	<tr>
		<td><?php echo $set['peid']; ?></td>
		<td><?php echo $set['username']; ?></td>
		<td><a href = "fm_accept_equipmentoffers.php?id=<?php echo $set['peid']; ?>">Accept</a></td>
		<td><a href = "fm_reject_equipmentoffers.php?id=<?php echo $set['peid']; ?>">Reject</a></td>
	</tr>
	<?php } ?>
</table>
</div>
