...
$mysql = "select adminid from Admin_Accounts where username = '$username' limit 1";
...
$sql = "select * from Admin_Accounts where username like '$username' and password like '$password' limit 1";
...
$result = $conn->query($sql);
	if (!$result->num_rows == 1) {
		...
		header("Location: fm_admin_account.php");
		exit;
	}
