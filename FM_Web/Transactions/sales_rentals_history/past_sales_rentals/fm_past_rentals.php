...
$sql = "SELECT count(*) FROM Rental_Transactions AS t, Rental_Listing AS r WHERE r.rid = t.rid AND t.renter = '$username'";
...
$mysql = "SELECT t.borrower, t.occured, r.item, r.price, r.duration FROM Rental_Transactions AS t, Rental_Listing AS r WHERE r.rid = t.rid AND t.renter = '$username' LIMIT $limit OFFSET $offset";
