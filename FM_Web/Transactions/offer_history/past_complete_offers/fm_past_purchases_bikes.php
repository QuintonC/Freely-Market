...
$mysql = "SELECT t.seller, t.occured, b.item, b.price, a.email FROM Bike_Transactions AS t, Buy_Listing AS b, User_Accounts AS a WHERE b.bid = t.bid AND a.aid = b.aid AND t.buyer = '$username' LIMIT $limit OFFSET $offset";
