...
$sql = "SELECT count(*) FROM Equipment_Transactions AS t, Equipment_Listing AS e WHERE e.eid = t.eid AND t.buyer = '$username'";
...
<title>Past Equipment Purchases</title>
<style>
...
<center><h2>Past Equipment Purchases</h2></center>
<?php echo "Page " . $pagenum . "of " . $lastpage;?><br />
<?php if ($pagenum == 1 and $lastpage != 1) { ?>
<a href="fm_past_purchases_equipment.php?pagenum=<?php echo $nextpage; ?>">NEXT</a>
<a href="fm_past_purchases_equipment.php?pagenum=<?php echo $lastpage; ?>">LAST</a>
<?php } elseif ($pagenum == $lastpage and $pagenum != 1) { ?>
<a href="fm_past_purchases_equipment.php?pagenum=1">FIRST</a>
<a href="fm_past_purchases_equipment.php?pagenum=<?php echo $prevpage; ?>">PREV</a>
