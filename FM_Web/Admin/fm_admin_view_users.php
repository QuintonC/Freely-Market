...
<div class="landing" style="overflow-y: scroll;">
	...
	<div class="listingOuter">
		...
		<div class="users">
			...
			<div class="listingPrice">
				<br><a class="infoButton" href ="fm_unrestrict_user.php?id=<?php echo $row['aid']; ?>">Regulate User</a><br><br>
				<a class="infoButton" href ="fm_restrict_user.php?id=<?php echo $row['aid']; ?>">Restrict User</a><br><br>
				<a class="infoButton" href ="fm_ban_user.php?id=<?php echo $row['aid']; ?>">Ban User</a><br>
			</div>
