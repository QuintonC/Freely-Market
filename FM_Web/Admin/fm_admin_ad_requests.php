	...
	<div class = "listingOuter">
		...
		<div class="item">
			...
			<div class="listingTitle">
				<?php echo $row['username'] . " " . $row['title']; ?>		
			</div>

			<div class="listingImage">
				<img src = "../images/<?php echo $row['file']; ?>" class="listingImageConstraints">	
			</div>

			<div class="listingPrice">
				<a class="buttonAlt" href="fm_accept_ad_request.php?id=<?php echo $row['adid']; ?>"><?php echo "Accept Request";?></a>		

				<a class="buttonAlt" href="fm_delete_ad_request.php?id=<?php echo $row['adid']; ?>"><?php echo "Deny Request";?></a>
			</div>
