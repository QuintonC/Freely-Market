...
<head>
    ...
    <title>Freely Market | View Listings</title>
</head>
...
<div class="rightSidebar">
    <div class="menuLink">
        <a href = "view_listing/view_bike/fm_sale_bike_listings.php?pagenum=1">View Bikes</a>
    </div>
    
    <div class="menuLink">
        <a href = "view_listing/view_equipment/fm_sale_equipment_listing.php?pagenum=1">View Equipment</a>
    </div>
    
    <div class="menuLink">
        <a href = "view_listing/view_rental/fm_rental_bike_listings.php?pagenum=1">View Rentals</a>
    </div>
</div>
