...
$sql = "SELECT count(*) FROM Buy_Listing WHERE owner = '$user' AND status = 'Active'";
...
#Show Sales Listed
$mysql = "SELECT * FROM Buy_Listing WHERE owner = '$user' AND status = 'Active' LIMIT $limit OFFSET $offset";
...
<a href="fm_view_user_bike_listings.php?pagenum=<?php echo $nextpage; ?>&id=<?php echo $user; ?>">NEXT</a>
<a href="fm_view_user_bike_listings.php?pagenum=<?php echo $lastpage; ?>&id=<?php echo $user; ?>">LAST</a>
<?php } elseif ($pagenum == $lastpage and $pagenum != 1) { ?>
<a href="fm_view_user_bike_listings.php?pagenum=1&id=<?php echo $user; ?>">FIRST</a>
<a href="fm_view_user_bike_listings.php?pagenum=<?php echo $prevpage; ?>&id=<?php echo $user; ?>">PREV</a>
