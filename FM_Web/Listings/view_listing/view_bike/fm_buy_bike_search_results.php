...
$mysql = "SELECT count(*) FROM Buy_Listing WHERE (item LIKE '%".$item."%' OR descr LIKE '%".$item."%') AND status = 'Active' AND owner != '$username'";
...
$sql = "SELECT * FROM Buy_Listing WHERE (item LIKE '%".$item."%' OR descr LIKE '%".$item."%') AND status = 'Active' AND owner != '$username' LIMIT $limit OFFSET $offset";
...
<a href="fm_buy_bike_search_results.php?pagenum=<?php echo $nextpage; ?>">NEXT</a>
<a href="fm_buy_bike_search_results.php?pagenum=<?php echo $lastpage; ?>">LAST</a>
<?php } elseif ($pagenum == $lastpage and $pagenum != 1) { ?>
<a href="fm_buy_bike_search_results.php?pagenum=1">FIRST</a>
<a href="fm_buy_bike_search_results.php?pagenum=<?php echo $prevpage; ?>">PREV</a>
