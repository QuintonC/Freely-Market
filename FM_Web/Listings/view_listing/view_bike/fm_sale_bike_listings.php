...
<head>
	...
	<title>Freely Market | Sale Listings</title>
</head>
...
<div class="landing" style="overflow-y: scroll;">
	...
	<div class = "titleAlt">
		...
		<div class="search">
			<form class="glow" name = "searchbar" action = "fm_buy_bike_search_results.php?pagenum=1" method="post">
		...
		<div class="listings">
			...
			<div class="item">
				...
				<div class="listingTitle">
					<a href = "fm_viewsale.php?id=<?php echo $row['bid'];?>"><?php echo $row['item']; ?></a>
				</div>
				...
				<a href="fm_viewsale.php?id=<?php echo $row['bid'];?>">
