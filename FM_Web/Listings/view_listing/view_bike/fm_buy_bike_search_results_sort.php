...
$sql = "SELECT * FROM Buy_Listing WHERE (item LIKE '%".$item."%' OR descr LIKE '%".$item."%') AND status = 'Active' AND owner != '$username' ORDER BY price ASC LIMIT $limit OFFSET $offset";
...
<table>
	<tr>
		<th>Item</th>
		<th><a href="fm_buy_bike_search_results_sort_asc.php?pagenum=1&id=<?php echo $item; ?>">Price</a></th>
		<th>Description</th>
		<th>Picture</th>
		<th>Id</th>
	</tr>
