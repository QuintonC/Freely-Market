...
#Show Sales Listed
$mysql = "SELECT b.item, b.price, b.descr, b.picture, b.owner, b.bid FROM Buy_Listing AS b, User_Accounts AS a WHERE a.aid = b.aid AND a.username != '$username' AND status = 'Active' ORDER BY price DESC LIMIT $limit OFFSET $offset";
...
<a href="fm_sale_listings_sort_asc.php?pagenum=<?php echo $nextpage; ?>">NEXT</a>
<a href="fm_sale_listings_sort_asc.php?pagenum=<?php echo $lastpage; ?>">LAST</a>
<?php } elseif ($pagenum == $lastpage and $pagenum != 1) { ?>
<a href="fm_sale_listings_sort_asc.php?pagenum=1">FIRST</a>
<a href="fm_sale_listings_sort_asc.php?pagenum=<?php echo $prevpage; ?>">PREV</a>
