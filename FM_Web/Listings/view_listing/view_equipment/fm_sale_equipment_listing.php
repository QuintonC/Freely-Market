...
<html>
<head>
	<title>Freely Market | Equipment Listings</title>
...
<div class="landing" style="overflow-y: scroll;">
	...
	<div class = "titleAlt">
		...
		<div class="search">
			<form class="glow" name = "searchbar" action = "fm_buy_equipment_search_results.php?pagenum=1" method="post">
		...
		<div class="listings">
			...
			<div class="item">
				...
				<div class="listingTitle">
					<a href = "fm_viewequipment.php?id=<?php echo $row['eid'];?>"><?php echo $row['item']; ?></a>
				</div>
				...
				<a href = "fm_viewequipment.php?id=<?php echo $row['eid'];?>">
