...
#Show Sales Listed
$mysql = "SELECT e.item, e.price, e.descr, e.picture, e.owner, e.eid FROM Equipment_Listing AS e, User_Accounts AS a WHERE a.aid = e.aid AND a.username != '$username' AND status = 'Active' ORDER BY price DESC LIMIT $limit OFFSET $offset";
...
<a href="fm_equipment_listings_sort_asc.php?pagenum=<?php echo $nextpage; ?>">NEXT</a>
<a href="fm_equipment_listings_sort_asc.php?pagenum=<?php echo $lastpage; ?>">LAST</a>
<?php } elseif ($pagenum == $lastpage and $pagenum != 1) { ?>
<a href="fm_equipment_listings_sort_asc.php?pagenum=1">FIRST</a>
<a href="fm_equipment_listings_sort_asc.php?pagenum=<?php echo $prevpage; ?>">PREV</a>
