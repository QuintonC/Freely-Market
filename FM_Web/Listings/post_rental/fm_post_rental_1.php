...
<script type="text/javascript">
    ...
    var c=document.forms["myForm"]["dur"].value;
    var d=document.forms["myForm"]["descr"].value;
...
<form name = "myForm" action="fm_post_rental.php" method="post" enctype="multipart/form-data" onsubmit = "return blank()">
	...
	<br />
	<br />
	<button type="submit" name = "submit">Post Rental</button>
	</form>
