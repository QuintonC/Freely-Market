...
<form name = "myForm" action="fm_post_equipment.php" method="post" enctype="multipart/form-data" onsubmit = "return blank()">
	...
	<br />
	<br />
	<button type="submit" name = "submit">Post Equipment</button>
	</form>
